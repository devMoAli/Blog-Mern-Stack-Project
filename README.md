...
##### React-NodeJS-Express-MongoDB-ReduxToolkit

![Full-Stack-Blog-Project](blog.gif)
![Full-Stack-Blog-Project](blog2.gif)
![Full-Stack-Blog-Project](blog3.gif)

- Register-Login with real verification email with reset password
- Categories & Posts connected to Database
- User can create new posts, Comment on posts, like posts
